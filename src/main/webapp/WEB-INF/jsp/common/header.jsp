...
<header class="main-header">
			...
			<a href="javascript:void(0)" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>菜单</b></span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>进销存管理系统</b></span>
			</a>
			...
			<nav class="navbar navbar-static-top">
					...
					<ul class="nav navbar-nav">
							...
							<ul class="dropdown-menu">
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${pageContext.request.contextPath}/dist/img/user4-128x128.jpg" class="img-circle"
                                                         alt="User Image">
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								class="hidden-xs">${employee.name }</span>
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="${pageContext.request.contextPath}/logout.htm" class="btn btn-default btn-flat">退出</a>
                </div>
              </li>
            </ul> </li>
